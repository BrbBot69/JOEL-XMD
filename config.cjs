...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Joel-Md&nS095Pf3",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by 𝕬𝖛𝖊.𝕭☚⍢⃝☚-Md',
  ...
  OWNER_NAME: process.env.OWNER_NAME || "ℓσя∂ 𝕬𝖛𝖊.𝕭☚⍢⃝☚",
